...
class _TestHostVideoPlayerApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    if (value is PrepareFiltersMessage) {
      buffer.putUint8(134);
      writeValue(buffer, value.encode());
    } else 
    ...
    } else 
{
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 134:       
        return PrepareFiltersMessage.decode(readValue(buffer)!);
...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.AVFoundationVideoPlayerApi.useFilter', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.useFilter was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final FilterMessage? arg_msg = (args[0] as FilterMessage?);
          assert(arg_msg != null, 'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.useFilter was null, expected non-null FilterMessage.');
          api.useFilter(arg_msg!);
          return <Object?, Object?>{};
        });
      }
    }
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.AVFoundationVideoPlayerApi.prepareFilters', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.prepareFilters was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final PrepareFiltersMessage? arg_msg = (args[0] as PrepareFiltersMessage?);
          assert(arg_msg != null, 'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.prepareFilters was null, expected non-null PrepareFiltersMessage.');
          api.prepareFilters(arg_msg!);
          return <Object?, Object?>{};
        });
      }
    }
