...
@class FLTPrepareFiltersMessage;
...
@interface FLTPrepareFiltersMessage : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithTextureId:(NSNumber *)textureId
...
@property(nonatomic, strong) NSNumber * textureId;
@property(nonatomic, strong) NSArray<NSDictionary<NSString *, NSString *> *> * filters;
@property(nonatomic, strong) NSNumber * append;
@end
...
- (void)useFilter:(FLTFilterMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
- (void)prepareFilters:(FLTPrepareFiltersMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
@end
