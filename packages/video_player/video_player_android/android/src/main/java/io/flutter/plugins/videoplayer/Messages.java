...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class PrepareFiltersMessage {
    private @NonNull Long textureId;
    public @NonNull Long getTextureId() { return textureId; }
    public void setTextureId(@NonNull Long setterArg) {
      if (setterArg == null) {
    ...
    private @NonNull List<Map<String, String>> filters;
    public @NonNull List<Map<String, String>> getFilters() { return filters; }
    public void setFilters(@NonNull List<Map<String, String>> setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"filters\" is null.");
      }
      this.filters = setterArg;
    }

    /** Constructor is private to enforce null safety; use Builder. */
    private PrepareFiltersMessage() {}
    public static final class Builder {
      private @Nullable Long textureId;
      public @NonNull Builder setTextureId(@NonNull Long setterArg) {
        this.textureId = setterArg;
      ...
      private @Nullable List<Map<String, String>> filters;
      public @NonNull Builder setFilters(@NonNull List<Map<String, String>> setterArg) {
        this.filters = setterArg;
        return this;
      }
      public @NonNull PrepareFiltersMessage build() {
        PrepareFiltersMessage pigeonReturn = new PrepareFiltersMessage();
        pigeonReturn.setTextureId(textureId);
    ...
    @NonNull Map<String, Object> toMap() {
      Map<String, Object> toMapResult = new HashMap<>();
      toMapResult.put("textureId", textureId);
      toMapResult.put("filters", filters);
      return toMapResult;
    }
    static @NonNull PrepareFiltersMessage fromMap(@NonNull Map<String, Object> map) {
      PrepareFiltersMessage pigeonResult = new PrepareFiltersMessage();
      Object textureId = map.get("textureId");
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId));
      Object filters = map.get("filters");
      pigeonResult.setFilters((List<Map<String, String>>)filters);
      return pigeonResult;
    }
  }
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte)134:         
          return PrepareFiltersMessage.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value)     {
      ...
      if (value instanceof PrepareFiltersMessage) {
        stream.write(134);
        writeValue(stream, ((PrepareFiltersMessage) value).toMap());
      } else 
      ...
      } else 
{
  ...
  public interface AndroidVideoPlayerApi {
    ...
    void useFilter(@NonNull FilterMessage msg);
    void prepareFilters(@NonNull PrepareFiltersMessage msg);
    ...
    static void setup(BinaryMessenger binaryMessenger, AndroidVideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.useFilter", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.prepareFilters", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ArrayList<Object> args = (ArrayList<Object>)message;
              PrepareFiltersMessage msgArg = (PrepareFiltersMessage)args.get(0);
              if (msgArg == null) {
                throw new NullPointerException("msgArg unexpectedly null.");
              }
              api.prepareFilters(msgArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
